...
# Create the application object stored (stored in app variable), along with CSS stylesheets
...
app.title = 'Panel Information and Management System'

# These 2 lines reduce the logs on your terminal so you could debug better when you encounter errors in app
